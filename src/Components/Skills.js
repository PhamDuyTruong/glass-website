...
export default function Skills({info}) {
    ...
    return (
        ...
        <div className="skill-con">
            ...
            <ProgressBar name={'Java'} image={progressImages[1]} progress={'80%'} bg={'#6BBE92'} desc={description} />
            ...
            <ProgressBar name={'Javascript'} image={progressImages[4]} progress={'86%'} bg={'#640211'} desc={description} />
